...
'Impetigo':40,'Covid-19':41}},inplace=True)
...
def DecisionTree():
    ...
    if(s1=='None' and s2=='None' and s3=='None' and s4=='None' and s5=='None'):
        ...
        if (h=='yes'):
            ...
            t4.delete("1.0", END)
            t4.insert(END, specialist.get(disease[a]))
        else:
            t1.delete("1.0", END)
            t1.insert(END, "Not Found")
...
def randomforest():
    ...
    if(s1=='None' and s2=='None' and s3=='None' and s4=='None' and s5=='None'):
        ...
        if (h=='yes'):
            ...
            t5.delete("1.0", END)
            t5.insert(END, specialist.get(disease[a]))
        else:
            t2.delete("1.0", END)
            t2.insert(END, "Not Found")
...
def NaiveBayes():
    ...
    if(s1=='None' and s2=='None' and s3=='None' and s4=='None' and s5=='None'):
        ...
        if (h=='yes'):
            ...
            t6.delete("2.0", END)
            t6.insert(END, specialist.get(disease[a]))
        else:
            t3.delete("1.0", END)
            t3.insert(END, "Not Found")
...
root = Tk()
root.configure(background='#102B3F')
...
# Heading
w2 = Label(root, text="NovaMed - Disease Predictor", fg="white", bg="#102B3F")
...
lrLb = Label(root, text="DecisionTree", fg="#330C2F")
lrLb.grid(row=15, column=0, pady=10,sticky=W)

destreeLb = Label(root, text="RandomForest", fg="#330C2F")
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="NaiveBayes", fg="#330C2F")
...
dst = Button(root, text="DecisionTree", command=DecisionTree,bg="#CBF3D2",fg="black")
dst.grid(row=8, column=3,padx=10)

rnf = Button(root, text="Randomforest", command=randomforest,bg="#CBF3D2",fg="black")
rnf.grid(row=9, column=3,padx=10)

lr = Button(root, text="NaiveBayes", command=NaiveBayes,bg="#CBF3D2",fg="black")
lr.grid(row=10, column=3,padx=10)

#textfileds
t1 = Text(root, height=1, width=40,bg="#fcd5ce",fg="black")
t1.grid(row=15, column=1, padx=10)

t2 = Text(root, height=1, width=40,bg="#fcd5ce",fg="black")
t2.grid(row=17, column=1 , padx=10)

t3 = Text(root, height=1, width=40,bg="#fcd5ce",fg="black")
t3.grid(row=19, column=1 , padx=10)

t4 = Text(root, height=1, width=20,bg="#B7C0EE",fg="black")
t4.grid(row=15, column=2, padx=10)

t5 = Text(root, height=1, width=20,bg="#B7C0EE",fg="black")
t5.grid(row=17, column=2 , padx=10)

t6 = Text(root, height=1, width=20,bg="#B7C0EE",fg="black")
t6.grid(row=19, column=2 , padx=10)
